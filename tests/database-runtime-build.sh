...
# Если базы данных Preview нет, следует инициализировать пустую БД
# только в артефакте сборки, не изменяя директорию проекта.
...
# Если база данных Preview существует, следует сохранить данные и файлы
# в той же директории, а затем выполнить синхронизацию схемы для артефакта сборки.
